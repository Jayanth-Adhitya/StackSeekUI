              ...
              >
                <CardContent className="p-6">
                  <div className="flex items-center gap-4 mb-4">
                    <div
                      className={`p-3 rounded-lg ${provider.color} transition-transform duration-300 hover:scale-110`}
                    >
                      <provider.icon />
                    </div>
                ...
                <form onSubmit={handlePrivateRepoConnect} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Create a personal access token with 'repo' scope from your
                      Git provider
                    </p>
                  </div>
          ...
          <div className="text-center mt-8 animate-in fade-in slide-in-from-bottom-1 duration-1000 delay-700">
            <Alert className="max-w-2xl mx-auto mb-6">
              ...
              <AlertDescription>
                ...
                We only access the minimum permissions needed for error
                analysis.
              </AlertDescription>
            </Alert>
